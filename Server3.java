...
public class Server3 {
	...
	public static void main(String[] args) throws IOException {
		ipBalancer = args[0];
		String s;
		FileWriter arq = new FileWriter("SD3.txt",false);
		...
		new Thread() { // do the consistency
			...
			public void run() {
				try{
					...
					ServerSocket serverConsistency = new ServerSocket(12223);
	...
	public static void readFile() {
		...
		try {
			BufferedReader buffRead = new BufferedReader(new FileReader("SD3.txt"));
	        String linha = "";
	        while (true) {
	            if (linha != null) {
	...
	public static void writeFile(String s) {
		...
		try {
			FileWriter arq = new FileWriter("SD3.txt",true);
